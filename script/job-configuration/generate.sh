...
jjm --locator "${REMOTE}" --build-command script/build.sh --junit 'build/log/junit-report.xml' --checkstyle 'build/log/checkstyle-*.xml' --recipients funtimecoding@gmail.com > job.xml
